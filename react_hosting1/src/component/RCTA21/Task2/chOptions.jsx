...
class ChOptions extends Component{
  handleChange = (e) => {
    ...
    return (
      <div className="row border bg-light">
        ...
        <div className="col-12 m-2">
          {this.makeCheckBox(allOptions.dept, dept.split(","), "dept", "Select Department")}
        </div>
        <div className="col-12 m-2">
          {this.makeCheckBox(allOptions.designation, designation.split(","), "designation", "Select Designation")}
        </div>
      </div>
    );
  }
