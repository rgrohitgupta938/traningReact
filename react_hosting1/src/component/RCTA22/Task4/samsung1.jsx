...
class Samsung1 extends Component {
  ...
  addToQueryString = (str, paraName, paraValue) =>
    paraValue ? (str ? `${str}&${paraName}=${paraValue}` : `${paraName}=${paraValue}`) : str;
  ...
  render() {
    ...
    let mobiles1 = mobiles.filter((mob) => mob.brand === "Samsung");
    let mobiles2 = this.filterParams(mobiles1, queryParams);
